...
from .decoder.bisenetv2 import BiSenetv2Decoder
...
class BiSenetv2(SegmentationModel):
    """
    Args:
    ...
    def __init__(
        ...
        encoder_outindice: List[int] = [-1],
        decoder_use_batchnorm: bool = True,
        decoder_channels: List[int] = [64,128],
        upsampling: int = 1,
        classes: int = 1,
...
def bisenetv2(model_name,encoder_name,**kwargs):
